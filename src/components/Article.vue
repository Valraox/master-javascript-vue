    ...
    methods: {
        ...
        deleteArticle(articleId) {
            swal({
                title: "¿Estás seguro?",
                text:
                    "El artículo va a ser permanentemente borrado",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete) {
                    axios
                        ...
                        .then((res) => {
                            //console.log(res);
                            var articleTitle = res.data.articleRemoved.title;
                            swal(
                                "Articulo " + articleTitle + " borrado",
                    ...
                    swal("Borrado de artículo cancelado");
                }
            });
        },
    },
